...
namespace FaisalRaheemAcademicDataApp.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,Age,Designation")] Teachers teachers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender,Age,Designation")] Teachers teachers)
        {
            if (id != teachers.Id)
            {
                return NotFound();
